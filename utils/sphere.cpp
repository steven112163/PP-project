...
void Sphere::sphere_from_subdivision(int num_of_subdivision) {
    ...
    glm::vec3 b = glm::vec3(0.0f, 0.942809f, 0.333333f);
    glm::vec3 c = glm::vec3(-0.816497f, -0.471405f, 0.333333f);
    glm::vec3 d = glm::vec3(0.816497f, -0.471405f, 0.333333f);
...
void Sphere::divide_triangle(glm::vec3 &a, glm::vec3 &b, glm::vec3 &c, int num_of_subdivision) {
    if (num_of_subdivision > 0) {
        ...
        glm::vec3 ac = glm::normalize((a + c) * 0.5f);
